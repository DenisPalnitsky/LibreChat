...
export default {
  ...
  com_ui_import_conversation_success: 'Successfully imported conversations',
  com_ui_import_conversation_error: 'There was an error upon importing your conversations',
